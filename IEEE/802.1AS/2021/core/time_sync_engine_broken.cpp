...
/**
 * @brief Architecture-compliant implementation section
 * @details Pure Standards layer implementation using hardware abstraction
 */
...
// REMOVED: start_measurements(), stop_measurements(), send_pdelay_request()
// These methods are now implemented as [[deprecated]] inline functions in the header
// to avoid C2084 "function already has a body" errors
